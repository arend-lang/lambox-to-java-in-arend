-- Extraction driver for the `binarytrees` benchmark. `binarytrees.lean` next to this file
-- is a verbatim copy of lean-to-lambdabox's
-- benchmarks/FromLeanCommon/binarytrees.lean (revision 58701f8); this file only
...
def suite_binarytrees := binarytrees 12
#erase suite_binarytrees to "prog.ast" mli "bench.mli"
