...
def run_arend(selection, index):
    ...
    if DAEMON:
        ...
        try:
            # No library positional: a daemon-served command reports
            # `[ERROR] Module not found: arend.yaml` for it.
            proc = subprocess.run([JAVA, JAVA_STACK, "-jar", str(AREND_JAR), module],
